...
Patients Table
Patient demographics, admission details, diagnosis, outcomes, and treatment cost.

Diagnosis Table
Mapping of DiagnosisID to DiagnosisName.

Outcomes Table
Mapping of OutcomeID to OutcomeName.

Labs Table
Patient lab test results and reference ranges.
...
Outcome Name Lookup using VLOOKUP / XLOOKUP

Length of Stay calculation using DATEDIF

Risk Score Classification based on age and outcome
...
Identification of high-risk patients based on age and outcomes
